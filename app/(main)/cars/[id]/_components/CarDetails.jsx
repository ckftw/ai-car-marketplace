    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div>
          ...
          {/* MILEAGE FUELTYPE AND TRANSMISSION INFO SECTION */}
          ...
          {car.status !== "UNAVAILABLE" && car.status !== "SOLD" && (
            <Button
      ...
      {/* DESCRIPTION AND FEATURES SECTUION */}
      <div className="mt-12 p-8 bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-2xl shadow-md border border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* Description Section */}
          <div>
            <h3 className="text-3xl font-semibold text-gray-800 mb-5 border-b pb-2 border-gray-200">
              Description
            </h3>
            <p className="whitespace-pre-line text-gray-600 leading-relaxed text-[17px]">
              {car.description}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-1 gap-4 text-gray-700 text-[16px]">
              <li className="flex items-center gap-3 hover:text-blue-700 transition">
                <span className="h-3 w-3 bg-blue-600 rounded-full shadow-md"></span>
              ...
              <li className="flex items-center gap-3 hover:text-blue-700 transition">
                <span className="h-3 w-3 bg-blue-600 rounded-full shadow-md"></span>
                <span className="font-medium">{car.color}</span> Exterior
              </li>
            </ul>
          </div>
        </div>
